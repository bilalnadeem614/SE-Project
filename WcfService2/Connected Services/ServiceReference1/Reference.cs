...
namespace WcfService2.ServiceReference1 {
    ...
    public interface IService1 {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/SignUpUser", ReplyAction="http://tempuri.org/IService1/SignUpUserResponse")]
        bool SignUpUser(string name, string email, string password, int role);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/SignUpUser", ReplyAction="http://tempuri.org/IService1/SignUpUserResponse")]
        System.Threading.Tasks.Task<bool> SignUpUserAsync(string name, string email, string password, int role);
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<WcfService2.ServiceReference1.IService1>, WcfService2.ServiceReference1.IService1 {
        ...
        public bool SignUpUser(string name, string email, string password, int role) {
            return base.Channel.SignUpUser(name, email, password, role);
        }
        
        public System.Threading.Tasks.Task<bool> SignUpUserAsync(string name, string email, string password, int role) {
            return base.Channel.SignUpUserAsync(name, email, password, role);
        }
